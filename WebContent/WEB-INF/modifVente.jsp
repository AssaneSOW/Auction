...
<title>Modification vente Enchères</title>
...
<body class="bg-light">
	...
	<form method="post" action="vente" class="form">
			...
			<div class="col-auto">
				<table>
					...
					<tr>
						...
						<td><input type="button" name="upload"
						class="form-control" id="upload" value="Charger une image"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="date" name="debutEnchere"
						class="form-control" id="debutEnchere" value="${param.debutEnchere}"></td>
					</tr>
					<tr>
						<td><label for="finEnchere">Fin de l'enchère :</label></td>
						<td><input type="date" name="finEnchere"
						class="form-control" id="finEnchere" value="${param.finEnchere}"></td>
					</tr>
				</table>
		...
		<div class="row justify-content-around">
			<div class="col-auto">
				<a href="enregistrerVente"><button type="submit" name="btn-enregistrer"
						...
						<a href="vente"><button type="submit" name="btn-retour"
						value="retour" class="btn btn-dark btn-lg">Retour</button></a>
						<a href="accueil"><button type="submit" name="btn-annulerVente"
						value="annulerVente" class="btn btn-danger btn-lg">Annuler la vente</button></a>
			</div>
		</div>
	</form>
